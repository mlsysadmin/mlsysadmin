...
const {
	...
	ValidateOTP,
	RegisterKyc,
} = require("../../controllers/_users/user.controller");
const {
	Validation,
} = require("../../middleware/_validator/validator.middleware");
const {
	searchKyc,
	LoginBody,
	otpProperty,
...
USER_ROUTER.post(
	"/search-kyc",
	verifyApiKey,
	Validation(searchKyc, "body", "payload"),
	SearchKyc
);
...
USER_ROUTER.post(
	"/send-otp",
	verifyApiKey,
	Validation(otpProperty, "body", "payload"),
	SendOTP
);
USER_ROUTER.post(
	"/validate-otp",
	verifyApiKey,
	Validation(validateOtp, "body", "payload"),
	ValidateOTP
);
USER_ROUTER.post(
	"/register-kyc",
	verifyApiKey,
	Validation(registerKyc, "body", "payload"),
	RegisterKyc
);
