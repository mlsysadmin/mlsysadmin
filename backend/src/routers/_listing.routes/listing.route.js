...
const { GetAllListing, AddPropertyListing, GetSellerListing, GetApproverByLevel } = require("../../controllers/_listings/listing.controller");
...
LISTING_ROUTER.get('/seller/all-listings/:seller_id', GetSellerListing);
