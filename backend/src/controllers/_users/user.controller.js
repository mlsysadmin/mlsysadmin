...
const {
	FindUserOne,
	FindOneSupportByEmail,
} = require("../../streamline/user.datastream");
	...
	SearchUser: async (req, res, next) => {
		try {
			...
			if (findUser) {
				...
				const success = SuccessFormatter(
					user,
					200,
					"It looks like there's already an account associated with these email address or mobile number."
				);
