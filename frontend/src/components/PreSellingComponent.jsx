...
const PreSellingComponent = () => {
	...
	const [headerText, setHeaderText] = useState("House and Lot Pre-Selling");
	...
	useEffect(() => {
		...
		if (queryParams.size !== 0) {
			...
			setHeaderText(`${title} Pre-Selling`);
			setBreadCrumbItems([{ title: "Pre-Selling" }, { title: title }]);
		} else {
			allPublicListing("house-and-lot");
			setPropertyType("house-and-lot");
			setHeaderText("House and Lot Pre-Selling");
		}
	}, []);
