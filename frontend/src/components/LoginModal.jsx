      ...
      {showLoginModal && (
        <div className="login-modal">
          <div className="login-modal-content">
            <span className="login-close-button" onClick={handleLoginModalClose}>&times;</span>
            <div className="login-logo"><img src={logo} alt="M Lhuillier Logo" /></div>
            ...
            <div className="login-forgot-password">
              <a className="login-forgot-password-link" href="#">Forgot your password?</a>
            </div>
            ...
            <div className="login-signup">
              Don't have an account? <a className="login-signup-link" href="#">Sign up</a>
            </div>
          </div>
        </div>
      )}
