...
import TopbarComponent from "../components/custom/TopbarComponent ";
import "../styles/MortgageCalculator.css";
import SliderComponent from "../components/custom/sliderComponent";
          ...
          <div className="first-column">
            <div className="mortgageContent">
              <div className="calcContainer">
                <h3 className="Label">Home price</h3>
              ...
              <div className="percentageContainer">
                <h3 className="Label">Down payment</h3>
