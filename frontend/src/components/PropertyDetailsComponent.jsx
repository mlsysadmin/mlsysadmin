...
const PropertyDetailsComponent = ({ onComplete }) => {
          ...
          <div className="tab-container">
            <div className="tab-category">
              ...
              <div className="tab-wrapper">
                <div className="tabs">
                  {['Service Office', 'Shop/Retail', 'Commercial Land/Lot'].map((tab) => (
                    <div
                      key={tab}
        ...
        <div className="listing-listing-type">
          ...
          <div className="listing-tab-container">
            ...
            <div className="listing-note">
              <p>To help home buyers better, we only accept these 3 types of listing.</p>
            </div>
            <div className="listing-reminders">
              ...
              <ul>
                <li>
                  We DO NOT accept pre-selling properties, ONLY ready for occupancy (RFO) ones that have either been bought
                  from a developer or have been constructed by a person for sale or rent.
                </li>
                <li>
