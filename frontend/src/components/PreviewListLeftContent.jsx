...
const PreviewListLeftContent = ({
  ...
  useEffect(() => {
    console.log("Property Type: ", oneListing.PropertyType);
          ...
          <table className={styles.specificationTable}>
            <tbody>
              <tr>
                <th>Property Type</th>
                <td>
                  {oneListing.PropertyType === "hotel/resort"
                    ? CapitalizeStringwithSymbol(oneListing.PropertyType)
                    : CapitalizeString(oneListing.PropertyType)}
                </td>
                <th>Floor Area</th>
