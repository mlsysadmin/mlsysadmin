...
import BannerProcessing from "../components/BannerProcessing";
import ListingStepsProcess from "./layout/ListingStepsProcess";
...
export const ShowDetailsProcessing = () => {
...
export default ShowDetailsProcessing;
