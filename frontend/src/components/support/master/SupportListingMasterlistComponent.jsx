...
const SupportListingMasterlistComponent = () => {
    useEffect(() => {
        GetAllForApproval()
    }, []);
            ...
            if (data.length !== 0) {
                ...
                const listingData = data.map((list, i) => {
                    ...
                    return {
                        ...
                        status: <Tag bordered={true} color="success" style={{ fontWeight: 500, fontSize: '14px' }}>{list.property_status}</Tag>
                    }
                });
    ...
    const handleShowDetails = (e) => {
        ...
        const props = {
            listing_id: e,
            isEditListing: false,
            tabTitle: 'Manage Active Listings',
            isShowDetails: true,
        }
        navigate(
            {
    ...
    return (
        <div>
            ...
            <div className={`support--pending-master-listing`}
                ...
                <SupportSubMenu title={'Manage Active Listings'}
                    isShowDetails={false} />
...
export default SupportListingMasterlistComponent;
